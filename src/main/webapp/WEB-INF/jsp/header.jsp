...
<header class="row-fluid">
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<a class="navbar-brand" href="main"><img alt="logo"
			src='${logo_url}'></a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item"><a class="nav-link"
					href='<c:url value="/main"/>'> <c:out
							value="${navbar_link_main_page}" /> <span class="sr-only">(current)</span>
				</a></li>
				<li class="nav-item"><a class="nav-link"
					href="<c:url value="/movies"/>"> <c:out
							value="${navbar_link_movies}" />
				</a></li>
				<li class="nav-item"><a class="nav-link"
					href="<c:url value="/actors"/>"> <c:out
							value="${navbar_link_actors}" />
				</a></li>
				<li class="nav-item"><a class="nav-link"
					href="<c:url value="/reviews"/>"> <c:out
							value="${navbar_link_reviews}" />
				</a></li>
				<c:choose>
					<c:when test="${sessionScope.user.role.toString() == 'ADMIN' }">
						<li class="nav-item"><a class="nav-link"
							href="<c:url value="/users"/>"> <c:out
									value="${navbar_link_users}" />
						</a></li>
					</c:when>
				</c:choose>
			</ul>
						...
						<c:when test="${sessionScope.authenticated != 'yes' }">
							...
							<div class="dropdown-menu dropdown-menu-right"
								...
								<form class="dropdown-item" method="post" action="app">
									<div class="form-group">
										<label for="emailOrlogin"> <c:out
												value="${log_in_form_label_email_name}" />
										</label> <input type="text" class="form-control" name="emailOrlogin"
											placeholder="<c:out value="${log_in_form_input_email_name}"/>">
									</div>
									<div class="form-group">
										<label for="password"> <c:out
												value="${log_in_form_label_password}" />
										</label> <input type="password" class="form-control" name="password"
											placeholder="<c:out value="${log_in_form_label_password}"/>">
									</div>
									<div class="form-check">
										<label class="form-check-label"> <input
											type="checkbox" class="form-check-input" name="rememberUser">
								...
								<a class="dropdown-item"
									href="<c:url value="/users/registration"/>"> <c:out
										value="${log_in_link_sign_up}" />
								</a> <a class="dropdown-item" href="#"> <c:out
										value="${log_in_link_forgot_password}" />
								</a>
							</div>
						</c:when>
						<c:otherwise>
							<a class="nav-link dropdown-toggle" href="#"
								id="navbar-user-menu" role="button" data-toggle="dropdown"
							...
							<div class="dropdown-menu dropdown-menu-right"
								...
								<div class="dropdown-divider"></div>
								<a class="dropdown-item"
									href="<c:url value="/app?action=log_off"/>"> <c:out
										value="${user_menu_log_off}" />
								</a>
							</div>
						</c:otherwise>
					</c:choose></li>
